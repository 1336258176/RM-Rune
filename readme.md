...
2024 赛季已经结束了，结果显然是不尽如人意的，我觉得自己不得不写点儿什么，好让我对这个队伍有一点交代，更多的是对自己有个交代。针对视觉方面来说有很大一部分是我的问题，自己负责的能量机关项目未能如期上场，在这个能量机关增益巨大的版本，我却不能给团队做出有用的东西，对此我感到非常愧疚。我认为有以下几点原因：

1. **测试不完全：** 能量机关不同于装甲板，它是需要自己制造的，尤其针对目前的传统识别来说，识别精度和准确性取决于自己队伍制造的精度上限，更严重者甚至完全不能适用于官方能量机关。这也就是我分区赛发现的识别方案所出现的致命问题，这也直接导致了分区赛完全没有能量机关，一丝补救的措施都没有。分区赛后的两个月是我压力最大的一段时间，一方面是进度的压力，一方面是自我怀疑，这一度让我有退队的想法，不过好在坚持下来了，于是之后我完全重构了识别方案，保证了识别官方能量机关的可行性。国赛的时候我始终认为能量机关是没什么大问题的，道具训练的时候也都表现正常，除了第二场我犯了一个低级错误，导致能量机关判断转向的时候出来始终是逆时针，宏观表现就是“预测反了”，不过这个问题场下也解决了，第三场表现正常，那么为什么这个问题赛前没有发现呢？首先在家这方面问题确实没有考虑到，其次，道具训练、适应性训练、包括第一场我方的能量机关居然全是逆时针旋转。排除操作手问题和车辆故障，国赛三场中应该至少有两场是能打能量机关的，虽然现在说这些已经没有意义了，但是我想表达的是对于国赛来说我已经做到了我该做的，至少不是因为没有能量机关而导致国赛失利。总之我建议后来接手能量机关的人要做好全面测试，**尤其是在传统识别方案下，一定要用官方的能量机关测试识别方案**。
2. **传承不完全：** 这版能量机关算是我从零开始写出来的，一步步试错，一步步纠错。首先，关于能量机关的开源甚少，有的也只是不成熟的方案，完全不能应用到赛场上。其次，由于上个学长的代码逻辑比较混乱、代码耦合性高，对我阅读造成很大障碍**（这里并没有甩锅的意思，纯粹我个人问题）**，在尝试阅读了一段时间后，考虑到要使用 ROS2 重构等因素，于是我决定按照自己的想法重写一版新的能量机关。然而从零开始是需要很大的试错成本的，这也间接导致了后面比赛出现的问题。针对这方面问题，我深恶痛绝，于是便有了这篇东西，我自认为这版代码的可读性还是可以的，耦合程度不算太高并且在不出意外以及官方能量机关不做大改变的情况下是完全可以上赛场的。下文会详细说明这版能量机关的**整体逻辑、调试方法、目前存在的问题以及未来改进方向**等，以期不让后来人重蹈覆辙。
3. **个人问题：** 对于学长的代码逻辑不懂之处并没有及时提问，而是选择了自己从零开始，这当然需要承担相当大的代价和成本。其次，我也时常懈怠，接近进度检查的时候才把工作赶出来，这样做难免导致代码容易出错。总之一句话：**不要临时抱佛脚，做好自己该做的**。
